...
namespace SistemaFacturacion
{
    ...
    {
        IServiceCustomer ServiceCustomer = new ServiceCustomer("Data Source=LOCALHOST;Initial Catalog=SistemaFacturacion;Integrated Security=True;Trust Server Certificate=True;");
