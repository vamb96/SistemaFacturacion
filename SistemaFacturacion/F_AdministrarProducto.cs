...
namespace SistemaFacturacion
{
    ...
    {
        IServiceProduct serviceProduct = new ServiceProduct("Data Source = LOCALHOST; Initial Catalog = SistemaFacturacion; Integrated Security = True; Trust Server Certificate=True;");
